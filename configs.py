...
class Config(object):
  ...
  DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://tmpilianaorp:WB8kBI3nazo9K0G9@cluster0.efs3v9y.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
